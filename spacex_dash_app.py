...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                figure=px.pie(spacex_df.groupby('Launch Site')['class'].sum().reset_index(),
                                ...
                                figure=px.scatter(spacex_df,x='Payload Mass (kg)',y='class',
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        filtered_df = filtered_df.value_counts('class').reset_index()
        fig = px.pie(filtered_df,
        values='count',names='class',
        title='Success in {site}'.format(site=entered_site))
        return fig
# TASK 4:
